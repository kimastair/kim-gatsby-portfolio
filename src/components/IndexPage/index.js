    ...
    <main className="index-page">
      ...
      <section className="left">
        <div className="flex-container">
          ...
          <div className="welcome">Hi, I'm Kim</div>
          <p className="intro">
            A senior frontend engineer building accessible, performant,
            beautiful experiences for the web.
          </p>
          ...
          <div>
            <a
              className="resume-link icon btn"
              href={`/documents/Kim Stair - Senior UX Engineer.pdf?${Date.now()}`}
            >
              <span>Resume</span>
              <DownloadIcon />
            </a>
